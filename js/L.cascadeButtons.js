L.Control.cascadeButtons = L.Control.extend({
    ...
    onAdd: function (map){
        ...
        this._buttons.forEach((button)=>{
            ...
            mainButton.setAttribute("title", button.title); // Agrega el tooltip al botón principal
            ...
            if(button.items && button.items.length > 0){
                ...
                button.items.forEach((item)=>{
                    ...
                    childButton.setAttribute("title", item.title); // Agrega el tooltip al botón secundario
